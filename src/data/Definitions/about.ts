...
const timeForTreatment: Definition = {
  ...
  description: [
    'Tout dépend de chacun et de la nécessité. Sont à considérer les causes qui nous amènent à ce soin, notre état général, l’ancienneté, l’importance et la chronicité de ce qui nous fatigue ou nous fait souffrir.',
    'Il peut être appréciable de recevoir une séance toutes les semaines ou tous les quinze jours, comme suffisant de recevoir une séance tous les mois ou à chaque changement de saison ou quand nous en ressentons le besoin pour dépasser un moment difficile.',
...
const generosity: Definition = {
  ...
  description: [
    'Si le shiatsu vous a fait du bien, parlez-en ! A l’heure où les nouvelles vont vites, principalement les mauvaises ou les fausses, devenez l’ambassadeur de cette bonne nouvelle dans votre vie qu’est le shiatsu. Ne gardez pas pour vous ce que les effets du shiatsu ont eu de bon pour votre état général.',
    'Si je vous suggère cela c’est parce qu’en interrogeant les patients qui reviennent me voir, je remarque souvent – et c’est bien sûr bon signe – qu’ils oublient  plein des petites choses qui les tracassaient avant le shiatsu et qui… ne les tracassent plus.',
    'Cela veut dire que quand ça va mieux, quand les choses rentrent dans l’ordre, nous oublions tout ce qui n’allait pas avant, comme si cela n’avait jamais existé.',
