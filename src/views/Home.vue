<template>
  <main class="home">
    <section class="left-side" v-on:wheel="lazyLoadImage">
      <Picture :images="tournesol" :shouldLoadPicture="true" description="Un magnifique tournesol en gros plan"/>
    ...
    <section class="right-side">
      ...
      <Picture :images="nenuphar" :shouldLoadPicture="loadNenuphar" description="Quelques nenuphar côte à côte sur un plan d'eau"/>
